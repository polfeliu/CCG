class Style:
    ...
    @property
    def vnew_line_function_bracket_open_before(self):
        return "\n" if self.new_line_function_bracket_open_before else ''

    @property
    def vnew_line_function_bracket_open_after(self):
        return '\n' if self.new_line_function_bracket_open_after else ''

    @property
    def vnew_line_function_bracket_close_before(self):
        return '\n' if self.new_line_function_bracket_close_before else ''

    @property
    def vnew_line_function_bracket_close_after(self):
        return '\n' if self.new_line_function_bracket_close_after else ''

    @property
    def vnew_line_function_prototype_type(self):
    ...
    @property
    def vspace_function_after_name_prototype(self):
        return ' ' if self.space_function_after_name_prototype else ''

    @property
    def vspace_function_after_name_declaration(self):
